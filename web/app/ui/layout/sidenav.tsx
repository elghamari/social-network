...
const navItems: NavItem[] = [
  ...
  { id: "profile", label: "Profile", href: "/profile", icon: "M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2 M12 3a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" },
  { id: "network", label: "Network", href: "/network", icon: "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 3a4 4 0 1 0 0 8 4 4 0 0 0 0-8z M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75" },
  ...
  { id: "notifications", label: "Notifications", href: "/notifications", icon: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9 M13.73 21a2 2 0 0 1-3.46 0" },
];
    ...
    <aside className="sidenav">
      <div className="sidenav__header">
        <Link href="/" className="sidenav__logo">
          <div className="sidenav__logo-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="url(#logoGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <defs>
      ...
      <nav className="sidenav__nav">
        <ul className="sidenav__list">
          {navItems.map((item) => (
            <li key={item.id}>
              <Link href={item.href} className={`sidenav__link ${isActive(item.href) ? "sidenav__link--active" : ""}`}>
        ...
        {user && (
          <div className="sidenav__user">
            ...
            <div className="sidenav__user-info">
              <span className="sidenav__user-name">{user.first_name} {user.last_name}</span>
